<template>
  <footer id="footer" class="footer px-3 pt-8 pb-mobile md:pb-8 flex flex-wrap font-semibold text-base md:text-xs">
    <!-- Logo -->
    ...
    <div class="text-center no-underline w-full md:w-1/2">
      ...
      <div class="flex flex-wrap align-center justify-center">
        <a v-for="sm in socialMedias" :key="sm.iconName" :href="sm.url">
          <font-awesome-icon :icon="{ prefix: sm.iconPrefix, iconName: sm.iconName }" :aria-labelledby="sm.ariaLabelledBy" :title="sm.iconTitle"/>
        </a>
      </div>
    </div>
  </footer>
