...
<script>
import HackfoolsHeader from "./hackfools/HackfoolsHeader.vue";

import Hackfools from "./hackfools/HackfoolsLogo";
import Shehacks from "./shehacks/ShehacksLogo";
import Interhack from "./interhack/InterhackLogo";
