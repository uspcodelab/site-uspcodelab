<template>
  <div class="flex flex-col items-center  mx-4">
    ...
    <p class="text-grey-darker">
      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Purus in massa tempor nec feugiat nisl pretium fusce id. Sapien eget mi proin sed libero enim. Urna nunc id cursus metus aliquam eleifend mi in. Mauris pellentesque pulvinar pellentesque habitant morbi tristique senectus et netus. Volutpat consequat mauris nunc congue nisi vitae suscipit tellus. Ultrices eros in cursus turpis massa tincidunt. Iaculis at erat pellentesque adipiscing commodo elit at imperdiet dui. Facilisis volutpat est velit egestas dui id ornare arcu.
    </p>
